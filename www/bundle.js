...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcCommonComponentsAppAppJsx = __webpack_require__(158);

	var _srcCommonComponentsAppAppJsx2 = _interopRequireDefault(_srcCommonComponentsAppAppJsx);

	main();

	function main() {
	    _reactDom2['default'].render(_react2['default'].createElement(_srcCommonComponentsAppAppJsx2['default'], null), document.getElementById('content'));
	}
